...
@Component({
  selector: 'app-dmin-add',
  templateUrl: './dmin-add.component.html',
  styleUrls: ['./dmin-add.component.css']
})
export class DminAddComponent extends SoraBaseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api(6, this.hcode, this.datestart, this.dateend);
  }
