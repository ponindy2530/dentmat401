...
@Component({
  selector: 'app-dmin-listadd',
  templateUrl: './dmin-listadd.component.html',
  styleUrls: ['./dmin-listadd.component.css']
})
export class DminListaddComponent extends SoraBaseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api5(30, this.hcode, this.datestart, this.dateend, this.id);
